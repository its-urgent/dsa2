// #include <bits/stdc++.h>
#include <iostream>   // For input/output streams like cout, cin
#include <fstream>    // For file input/output streams like ifstream, ofstream
#include <string>     // For string manipulation functions and classes
#include <vector>     // For dynamic arrays (vectors)
#include <algorithm>  // For algorithms like sorting, searching
#include <cmath>      // For mathematical functions like pow, sqrt
#include <cstdlib>    // For C standard library functions like rand, srand
#include <ctime>      // For time-related functions like time
